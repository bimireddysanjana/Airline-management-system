...
case 4:
Page 8
printf("\n\tYour Details Have Been Saved To A File(If
Any)");
return(0);
default:
printf("\nInvalid choice");
...
printf("----------------------------------------------------------------
----------------------------------------------------------------------------------------");
printf("\nFlight.No\t Name\t\t\t\t Destinations |\t\t\t
Charges \t\t Date \t\t Time\n");
printf("----------------------------------------------------------------
----------------------------------------------------------------------------------------");
printf("\n1001\t\t Flight 01\t\t\t Hyderabad To Chennai
|\t\t\tRs.1500 \t\t 01 Aug 2022\t\t 10.00");
printf("\n1002\t\t Flight 02\t\t\t Hyderabad To Goa
|\t\t\tRs.2500 \t\t 02 Aug 2022\t\t 15.00");
printf("\n1003\t\t Flight 03\t\t\t Hyderabad To Delhi
|\t\t\tRs.7000 \t\t 03 Aug 2022\t\t 14.00");
printf("\n1004\t\t Flight 04\t\t\t Hyderabad To Mumbai
|\t\t\tRs.5500 \t\t 04 Aug 2022\t\t 19.00");
printf("\n1005\t\t Flight 05\t\t\t Hyderabad To Kerala
|\t\t\tRs.3500 \t\t 05 Aug 2022\t\t 11.00");
printf("\n1006\t\t Flight 06\t\t\t Hyderabad To USA
|\t\t\tRs.90000 \t\t 06 Aug 2022\t\t 09.00");
printf("\n1007\t\t Flight 07\t\t\t Hyderabad To Bangkok
|\t\t\tRs.50000 \t\t 04 Aug 2022\t\t 15.30");
printf("\n1008\t\t Flight 08\t\t\t Hyderabad To Singapur
|\t\t\tRs.60000 \t\t 08 Aug 2022\t\t 16.40");
Page 9
printf("\n1009\t\t Flight 09\t\t\t Hyderabad To Germany
|\t\t\tRs.80000 \t\t 04 Aug 2022\t\t 19.55");
printf("\n1010\t\t Flight 10\t\t\t Hyderabad To SriLanka
|\t\t\tRs.15000 \t\t 02 Aug 2022\t\t 15.15");
}
void reservationA(void)
{
char confirm;
...
if(confirm == 'y')
{
fprintf(fp1,"%s\t\t%d\t\t%.2f\n",&passdetails.name,passdetails.flight_nu
m,charges);
printf("\n**************");
...
printf("\nDeparture Date and time\t\t\t: 02/08/2022-
12:00pm(IST)");
}
if (flight_num==1003)
{
...
printf("\nDeparture Date and time\t\t\t: 03/08/2022-
8:00am(IST)");
}
if (flight_num==1004)
{
...
printf("\nDeparture Date and time\t\t\t: 05/08/2022-
7:00am(IST)");
}
if (flight_num==1006)
{
...
printf("\nDeparture Date and time\t\t\t: 04/08/2022-
1:00pm(IST)");
}
if (flight_num==1008)
{
...
printf("\nDeparture Date and time\t\t\t: 08/08/2022-
4:00pm(IST)");
}
if (flight_num==1009)
{
...
{
printf(" \n\n\n WELCOME TO OUR Air Lines Management
System !! ");
